...
class DataTransformationConfig:
    ...
    transformed_train_file_pat=os.path.join(artifact_dir,'test.npy')
    transformed_train_file_pat=os.path.join(artifact_dir,'preprocessor.pkl')
...
def get_data(feature_store_file_path: str) ->pd.DataFrame:
    ...
    try:
        ...
        data.raname(columns={"Good/Bad": TARGET_COLUMN},inplace=True)
...
def get_data_transformer_objects(self):
    ...
    def initiate_data_transformation(self):
        ...
        try:
            dataframe= self.get_data(feature_store_file_path=selffeature_store_file_path)
